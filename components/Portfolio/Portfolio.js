    ...
    <section id="portfolio" className={`${container} ${isLightMode ? lightMode : ''}`}>
      ...
      <div className={portfolioCards}>
        <div className={card}>
          ...
          <div>
            <Link href="https://whatsthesong.vercel.app/"><a target="_blank">view site</a></Link>
            <span className={dash}>&mdash;</span>
            <Link href="https://github.com/Arash-11/_whatsthesong"><a target="blank">view code</a></Link>
          </div>
        ...
        <div className={card}>
          ...
          <div>
            <Link href="https://modernhn.netlify.app/"><a target="_blank">view site</a></Link>
            <span className={dash}>&mdash;</span>
            <Link href="https://github.com/Arash-11/modern-hacker-news"><a target="_blank">view code</a></Link>
          </div>
      ...
      <Link href="https://github.com/Arash-11">
        <a className={seeMore} target="_blank">View more on GitHub</a>
      </Link>
